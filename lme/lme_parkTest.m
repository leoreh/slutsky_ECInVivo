...
%   Generalized Linear Mixed Model (GLME) and performs the Modified Park
%   Test to determine the appropriate distribution family. If lambda ~ 2,
%   compares Gamma vs log-normal approaches. 
%
%   INPUTS:
