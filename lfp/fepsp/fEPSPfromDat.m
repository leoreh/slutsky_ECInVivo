...
%   fsIn        numeric. sampling frequency of dat file {30000}. If tdt
%               will be overwritten from store
...
addOptional(p, 'fsIn', 30000, @isnumeric);
...
switch recSystem
    case 'oe'
        % note the b2uv conversion was tested rhd2000 and analog input to
        % oe. in doubt you should check structure.oebin
        b2uv = 0.195;   
