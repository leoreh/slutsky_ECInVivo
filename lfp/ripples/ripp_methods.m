...
%       evt_gate applies. The same .qa is the headless default of ripp_curate
...
%       .qa        - <struct> the default QA filter (applied by evt_gate):
...
% the default QA filter (the evt_gate spec): valid states, low EMG, MUA gate
