function evtSpks = evt_spksParams(spkTimes, evtTimes, ctrlTimes, peakTime, varargin)
% EVT_SPKSPARAMS Per-unit scalar spike-modulation stats (event vs control).
%
%   evtSpks = EVT_SPKSPARAMS(spkTimes, evtTimes, ctrlTimes, peakTime, varargin)
%
%   Called by the orchestrator evt_spks; parallels ripp_params / ed_params.
%
%   SUMMARY:
