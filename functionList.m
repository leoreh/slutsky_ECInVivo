...
% brst (mea)
brst = brst_mea(spikes.times, 'binsize', [], 'isiThr', 0.05,...
...
% state ratio according to mfr percetiles. state mfr now comes from the
% brstStates table (spk_byCond), not from a states field inside fr
