...
clear orig_files
orig_files{1} = 'F:\Data\lh81\lh81_210204_190000\lh81_210204_190000.emg.dat';
orig_files{2} = 'F:\Data\lh81\lh81_210205_070500\lh81_210205_070500.emg.dat';
clip{1} = [1, seconds(minutes(2)) * 20000];
datInfo = preprocDat('orig_files', orig_files, 'mapch', 1,...
    'rmvch', [], 'nchans', 1, 'saveVar', true,...
    'chunksize', 1e7, 'precision', 'int16', 'clip', []);
...
sSig = as_prepSig([basename, '.lfp'], [basename, '.emg.dat'],...
    'eegCh', [5 : 8], 'emgCh', [1], 'saveVar', true, 'emgNchans', 1,...
    'eegNchans', nchans, 'inspectSig', true, 'forceLoad', true,...
    'eegFs', 1250, 'emgFs', 1017.25262451172, 'eegCf', [], 'emgCf', [10 450], 'fs', 1250);
