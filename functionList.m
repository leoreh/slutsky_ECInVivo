...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
basepath = 'J:\Data\lh107\2022-05-12_10-23-02';
mapch = 1 : 21;
rmvch = [18];
...
% call for eeg
sSig = as_prepSig([basename, '.emg.dat'], [basename, '.emg.dat'],...
...
[expData, xData] = sessions_catVarTime('mname', mname,...
    'dataPreset', {'sleep_emg', 'spec', 'sr'}, 'graphics', true,...
