...
%                     .mcc      : (nChunks x 1) Mean Correlation.
%                     .cc       : (nChunks x 1) Cell array of correlation matrices.
%                     .info     : Info and hardcoded parameters.
%
...
for iChunk = 1:nChunks
    ...
    % Correlations
    [frNet.mcc(iChunk), frNet.cc{iChunk}] = fr_corr(frMat, ...
