...
% adjust batches to winWh
nbatchWh = ceil(diff(winWh) * ops.fs / ops.NT);
winRatio = floor(Nbatch / nbatchWh);
ops.nSkipCov = ops.nSkipCov / winRatio;
...
CC = CC / ceil((nbatchWh-1)/ops.nSkipCov); % normalize by number of batches
