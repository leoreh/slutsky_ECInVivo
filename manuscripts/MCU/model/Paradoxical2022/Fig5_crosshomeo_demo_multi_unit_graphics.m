%called by Fig5_crosshomeo_demo_multi_unit
%ssaray@ucla.edu
%dbuono@ucla.edu
...
if(1)
     ...
     hold on
      ...
      subplot(5,2,[9 10])
      plot(NaN(nTrial,20),'color',[77/255 166/255 77/255 0.25],'ydatasource','trialhistFCa(:,1:20)','linewidth',1);
      hold on
      plot(NaN(nTrial,1),'color',[77/255 166/255 77/255],'ydatasource','nanmean(trialhistFCa,2)','linewidth',4);
      plot(NaN(nTrial,Ni),'color',[255/255,112/255,112/255 0.25],'ydatasource','trialhistFCaInh','linewidth',1); 
      plot(NaN(nTrial,1),'color',[255/255,112/255,112/255],'ydatasource','nanmean(trialhistFCaInh,2)','linewidth',4);
