...
mname           = 'lh142';
basepath        = 'H:\Data\lh142\2023-10-12_09-31-27';
exp             = [1];
...
% clip bad parts
clear orig_files
orig_files{1} = 'H:\Data\lh142\lh142_231009_102856\lh142_231009_102856.dat';
% orig_files{2} = 'H:\Data\lh142\lh142_231007_162414\lh142_231007_162414.dat';
clip = cell(1, length(orig_files));
clip{1} = [seconds(minutes(831)), seconds(minutes(1337))] * 20000;
