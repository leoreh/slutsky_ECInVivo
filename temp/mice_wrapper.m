...
% clip bad parts
clear orig_files
orig_files{1} = 'J:\Data\lh137\lh137_230517_085224\lh137_230517_085224.dat';
orig_files{2} = 'J:\Data\lh137\lh137_230517_201549\lh137_230517_201549.dat';
clip = cell(1, length(orig_files));
clip{1} = [seconds(minutes(546)), Inf] * 20000;
...
mname           = 'lh136';
basepath        = 'K:\Data\lh136\2023-05-21_08-57-35';
exp             = [1, 3];
...
% clip bad parts
clear orig_files
orig_files{1} = 'J:\Data\lh134\lh134_230509_085817\lh134_230509_085817.dat';
orig_files{2} = 'J:\Data\lh134\lh134_230509_113742\lh134_230509_113742.dat';
clip = cell(1, length(orig_files));
clip{2} = [seconds(minutes(112)), seconds(minutes(176))] * 20000;
datInfo = preprocDat('orig_files', orig_files, 'mapch', 1 : nchans,...
    'rmvch', [], 'nchans', nchans, 'saveVar', true,...
    'chunksize', 1e7, 'precision', 'int16', 'clip', clip);
