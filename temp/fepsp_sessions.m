...
for ifile = 1 : nfiles
    ...
    % timestamps
    protocol_info = fepsp_getProtocol('protocol_id',...
        v(ifile).lfp.fepsp_protocol, 'fs', lfp.fs);
    tstamps = [1 : length(traces)] / lfp.fs * 1000 - protocol_info.stim_times(1); 
